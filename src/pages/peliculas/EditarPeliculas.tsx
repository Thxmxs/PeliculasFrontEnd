  ...
  return (
    <div>
      <form onSubmit={formik.handleSubmit}>
        ...
        <div className="form-group">
            <label style={{color:formik.errors.trailer && formik.touched.trailer ? 'red' :'black'}} htmlFor="trailer">{formik.errors.trailer && formik.touched.trailer ? formik.errors.trailer : 'Titulo'}</label>
